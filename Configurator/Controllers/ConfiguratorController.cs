    ...
    public class ConfiguratorController : Controller
    {
        ...
        public ActionResult Items(int id)
        {
            var model = new AdminItemsViewModel
            {
                ...
                ItemTypeId = id,
                ItemTypeName = _typeService.GetItemTypesById(id).Name,
                PartName = _partService.GetPartById(_typeService.GetItemTypesById(id).PartId).Name,
                ProductName = _productService.GetProductById(_partService.GetPartById(_typeService.GetItemTypesById(id).PartId).ProductId).Name,
                PartId = _typeService.GetItemTypesById(id).PartId,
                ProductId = _partService.GetPartById(_typeService.GetItemTypesById(id).PartId).ProductId
            };
        ...
        public string GetImgPath(string code)
        {
            ...
            return _finalDesignService.GetImagePath(code);
        }
